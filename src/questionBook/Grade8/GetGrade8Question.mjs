...
const Grade8Questions = {
    ...
    // q9: generate(generatePerimeterAndArea),               // Grade 7 Q9 - DISABLED: Layout issues
    // q10: generate(generateCommercialMathG7),               // Grade 7 Q10
    // q11: generate(generateRationalNumbers),                 // Ch 1
    q9: generate(generateLinearEquationsGrade8),           // Ch 2
    q10: generate(generateQuadrilateralsGrade8),            // Ch 3
    // q12: generate(generatePracticalGeometryGrade8),         // Ch 4
    // q15: generate(generateDataHandling),                    // Ch 5
    q11: generate(generateSquaresCubes),                    // Ch 6
    q12: generate(generateCubesRoots),                      // Ch 7
    q13: generate(generateComparingQuantities),             // Ch 8
    q14: generate(generateAlgebraExpressions),              // Ch 9
    q15: generate(generateAlgebraIdentities),              // Ch 9 extension
    // q21: generate(generateVisualizingSolidShapes),         // Ch 10
    q16: generate(generateMensurationGrade8),              // Ch 11
    // q20: generate(generateExponentsGrade8),                // Ch 12
    q17: generate(generateDirectInverseVariation),         // Ch 13
    // q25: generate(generateFactorisation),                  // Ch 14
    q18: generate(generateGraphs),                         // Ch 15
    ...
    q19: generate(generateDataInterpretationAdvanced),
    ...
    q20: generate(generateGrade7Algebra),                  // Grade 7 Q13
    // q39: generate(generateAlgebraWordProblemTable),        // Grade 7 Q14
    q21: generate(generateLinesAndAngles),                 // Grade 7 Q15
    q22: generate(generateTrianglesProperties),            // Grade 7 Q16
    ...
    q23: generate(generateDataHandlingG7),                 // Grade 7 Q19
